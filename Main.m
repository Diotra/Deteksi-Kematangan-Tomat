...
image_folder = 'D:\Kuliah\Sem 8\Skripsi\Testing_Matlab\Training\mature';
...
image_folder = 'D:\Kuliah\Sem 8\Skripsi\Testing_Matlab\Training\half-mature';
filenames = dir(fullfile(image_folder, '*.jpg'));
total_images = numel(filenames);
...
image_folder = 'D:\Kuliah\Sem 8\Skripsi\Testing_Matlab\Training\immature';
filenames = dir(fullfile(image_folder, '*.jpg'));
total_images = numel(filenames);
